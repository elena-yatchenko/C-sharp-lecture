...
// Массив - структура данных, предназначенная для хранения элементов одного типа.

// Используем массивы для хранения элементов и последующего их использования,  для поиска элементов по каким-либо
// критериям или для вычисления характеристик для всего набора (сумма, среднее арифметическое и проч.)
...
// new int[10] - выделение памяти для массива (т.е. выделяем память на 10 символов)
